...
import "./CompletedRides.css"; // Reuse the same CSS
import { 
  FaDownload, 
  FaMoneyBillWave, 
  FaUser, 
...
function CompletedRides() {
  ...
  // Fetch rides with completed status only
  const fetchRides = async (append = false) => {
    try {
      ...
      const params = new URLSearchParams({
        ...
        status: "completed" // Always fetch completed rides
      });
  ...
  const clearFilters = () => {
    setFilters({ status: "completed", sortBy: "requestDate", sortOrder: "asc" });
  };
  ...
  const exportCSV = () => {
    ...
    link.setAttribute("download", "Completed_rides.csv");
  ...
  return (
    <div className="admin-rides-page">
      ...
      <div className="info-banner">
        ...
        <p>Showing all rides with completed status</p>
      </div>
      ...
      <div className="controls-container">
        <div className="search-box">
          ...
          <input
            type="text"
            placeholder="Search rides by customer, driver, or location..."
            value={searchTerm}
      ...
      <div className="rides-grid">
        {filteredRides.length > 0 ? filteredRides.map((ride) => (
          ...
          <div className="empty-state">
            ...
            <p>There are currently no rides with completed status</p>
          </div>
        )}
      </div>
        ...
        <div className="modal-overlay" onClick={() => setSelectedRide(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h2>Completed Trip Details #{selectedRide.trip_id}</h2>
            ...
            <div className="modal-body">
              <div className="detail-grid">
                <div className="detail-group">
                  ...
                  <DetailItem label="Status" value="Completed" badgeClass="status-completed" />
                </div>
